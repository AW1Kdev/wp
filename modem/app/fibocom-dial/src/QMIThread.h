...
extern int requestGetSIMCardNumber(PROFILE_T *profile);
extern int requestSimBindSubscription_NAS_WMS(void);
extern int requestSimBindSubscription_WDS_DMS_QOS(void);
extern int get_private_gateway(char *outgateway);
